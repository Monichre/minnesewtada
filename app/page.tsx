      ...
      <section>
        <div className="mx-auto max-w-screen-xl gap-12 px-4 py-28 text-gray-600 md:px-8">
          <div className="mx-auto max-w-4xl space-y-5 text-center">
            {/* <h1 className="text-sm font-medium text-indigo-600">Build products for everyone</h1> */}
            <h2 className="mx-auto text-4xl font-extrabold text-gray-800 md:text-5xl">
              <span className="bg-gradient-to-r from-[#4F46E5] to-[#E114E5] bg-clip-text text-transparent">
                Welcome to Minnesewtada!
              </span>
            </h2>
            <p className="mx-auto max-w-2xl">Take a look at our latest products.</p>
          </div>
        </div>
      </section>
      <ThreeItemGrid />
